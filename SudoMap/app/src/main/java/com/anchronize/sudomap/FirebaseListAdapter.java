...
public abstract class FirebaseListAdapter<T> extends BaseAdapter {
    ...
    private Button[] voteButtons = new Button[100];
    ...
    public FirebaseListAdapter(Query mRef, Class<T> mModelClass, int mLayout, Activity activity) {
        ...
        mListener = this.mRef.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String previousChildName) {
                ...
                // Log.d("last key", lastKey);

                childrenCount = (int) dataSnapshot.getChildrenCount();



                mVoteRef = dataSnapshot.getRef().child("votes");
                setReference(mVoteRef);
    ...
    public class UpvoteListener implements View.OnClickListener{
        ...
        public void onClick(View view) {
            ...
            Firebase chatRef = refList.get(tag);
    ...
    public class DownvoteListener implements View.OnClickListener{
        @Override
        public void onClick(View view) {
            int tag = (Integer) view.getTag();
            Firebase chatRef = refList.get(tag);
